...
|-----------|----------|----------|
| React, UI, components, charting | Dallas | Chat UI improvements, Recharts, responsive design, CSS |
| .NET APIs, MCP tools, EF Core | Parker | RouteQuestion, GetMetrics, ChatController, rollup queries |
| Tests, validation, edge cases | Lambert | Unit tests, integration tests, coverage gaps |
